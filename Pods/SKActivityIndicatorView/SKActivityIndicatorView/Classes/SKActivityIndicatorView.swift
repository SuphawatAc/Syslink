...
public class SKActivityIndicator: NSObject {
    ...
    fileprivate func registerForKeyboardNotificatoins() {
        NotificationCenter.default.addObserver(self, selector: #selector(self.configureActivityIndicatorPosition), name:NSNotification.Name(rawValue: "didChangeStatusBarOrientationNotification"), object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(self.configureActivityIndicatorPosition), name:NSNotification.Name(rawValue: "keyboardWillHideNotification"), object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(self.configureActivityIndicatorPosition), name:NSNotification.Name(rawValue: "keyboardDidHideNotification"), object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(self.configureActivityIndicatorPosition), name:NSNotification.Name(rawValue: "keyboardWillShowNotification"), object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(self.configureActivityIndicatorPosition), name:NSNotification.Name(rawValue: "keyboardDidShowNotification"), object: nil)
    }
