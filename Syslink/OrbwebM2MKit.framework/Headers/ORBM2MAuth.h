...
/** @typedef ORBM2MAuthResultCallback
 ...
 @param result success Optionally; the signed in success.
...
- (void) signInWithRDZ:(NSString *)rdz_path
                   SID:(NSString*) SID
...
- (void)sendCommand:(NSString*)cmd
         connection:(ORBM2MConnection*)connection
             userId:(NSString*)userId
           password:(NSString*)password
         completion:(ORBM2MAuthResultCallback)completion;
